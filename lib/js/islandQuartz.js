var $ = jQuery.noConflict();
    ...
    $('.wpcf7-response-output').removeClass('wpcf7-validation-errors').addClass('alert alert-warning pt-2 pb-2');
    $('.woocommerce-MyAccount-navigation').find('ul').addClass('memberMenu');
    $('.memberMenu').find('li').find('a').addClass('btn btn-info btn-block mb-2 text-uppercase');
    $('.u-column1').removeClass('woocommerce-Address noClass').addClass('alert alert-dark');
    $('.u-column2').removeClass('woocommerce-Address noClass').addClass('alert alert-light');
    $('.page-id-8').find('.woocommerce-MyAccount-content').addClass('alert alert-secondary');
    $('.woocommerce-Button').addClass('btn btn-success ml-1').removeClass('woocommerce-Button button');
...
function checkWidth() {
    if ($window.width() < 768) {
        ...
        $('#copyright').removeClass('text-center').addClass('text-left');
    };
    if ($window.width() >= 768) {
        $('#about').removeClass('display-5').addClass('display-4');
        $('#copyright').removeClass('text-left').addClass('text-center');
